...
describe("separated authentication entry points", () => {
  ...
  it("keeps production, preview, and localhost auth redirects exact", () => {
    ...
    expect(config).toContain(
      '"https://muber-ad7wnccj8-manuel-rodriguezs-projects-f5946c44.vercel.app/auth/callback"',
    );
    expect(config).toContain(
      '"https://muber-ad7wnccj8-manuel-rodriguezs-projects-f5946c44.vercel.app/auth/reset"',
    );
